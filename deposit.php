...
if (isset($_POST["deposit"])) {
    deposit($conn, $user, $_POST["deposit"]);
...
<body>
    ...
    <form class="card-details text-center" action="deposit.php" method="POST">
        <h2>Deposit using OVO</h2>
        <div class="">
            <label> Your Phone Number </label>
            <input type="number" class="" value="08" required />
        </div>
        <div class="">
            <label> Amount </label>
            <input type="number" class="" placeholder="Rupiah" name="deposit" required />
        </div>
